 ...
 */
    [_QWERTY] = LAYOUT(
     ...
     KC_TAB  , HOME_A ,HOME_S ,HOME_D  , HOME_F ,   KC_G ,                                        KC_H,HOME_J ,HOME_K, HOME_L ,KC_SCLN, KC_TILD,
     CTL_ESC , KC_Z ,  KC_X   ,  KC_C  ,   KC_V ,   KC_B ,                      KC_N,   KC_M ,  KC_COMM, KC_DOT ,KC_SLSH, KC_QUOTE,
                                   SYM , GAMING, KC_LGUI,  SPACE_LWR,            RAISE_ENT , KC_BSPC, NAV, SYM
    ),
 ...
 */
    [_NAV] = LAYOUT(
                _______, _______, _______, _______, _______,                                     _______ , KC_HOME, KC_UP,   KC_END,  KC_LBRC,
      _______ , KC_LCTL, KC_LALT, KC_LGUI, KC_LSFT, _______,                                     KC_EQL  , KC_LEFT, KC_DOWN, KC_RGHT, _______, KC_RBRC,
      _______ , _______, _______, _______, _______, _______,                                     KC_MINUS, KC_LPRN, KC_RPRN, _______, KC_BSLS, _______,
                                           _______, _______, _______, KC_SPC , KC_ENT , KC_DEL , _______, _______
),
 ...
 */
    [_SYM] = LAYOUT(
     ...
     KC_PIPE , KC_F1  ,  KC_F2 , KC_F3  , KC_F4  , KC_F5  ,                                     _______,  KC_F6  ,  KC_F7 , KC_F8 , KC_F9 , KC_F10 ,
 ...
 * |        |  F9  | F10  | F11  | F12  |      |                              |      |      |      |      |      |        |
 * |--------+------+------+------+------+------|                              |------+------+------+------+------+--------|
 * |        |  F5  |  F6  |  F7  |  F8  |      |                              | TOG  | SAI  | HUI  | VAI  | MOD  | Reset  |
 * |--------+------+------+------+------+------+-------------.  ,-------------+------+------+------+------+------+--------|
 ...
 */
    [_FUNCTION] = LAYOUT(
                KC_F9 ,  KC_F10,  KC_F11,  KC_F12, _______,                                     RGB_M_R, _______, _______, _______,  _______,
      _______,  KC_F5 ,  KC_F6 ,  KC_F7 ,  KC_F8 , _______,                                     RGB_TOG, RGB_SAI, RGB_HUI, RGB_VAI,  RGB_MOD, QK_BOOT,
      _______,  KC_F1 ,  KC_F2 ,  KC_F3 ,  KC_F4 , _______,                                     _______, RGB_SAD, RGB_HUD, RGB_VAD, RGB_RMOD, _______,
                                 _______, _______, _______, _______, _______, _______, _______, _______
    ),
...
//╷         ╷         ╷         ╷         ╷         ╷         ╷         ╷╷         ╷         ╷         ╷         ╷         ╷         ╷         ╷
   ...
   _______,  _______,  _______,  _______,  _______,  _______,  _______,   _______,  _______,  _______,  _______,  _______,  _______,  _______,
    ...
    [_GAMING] = LAYOUT(
       ...
       _______, GUI_Z  , GUI_X  , GUI_C  , GUI_V  , _______,                                     _______,  KC_1  ,  KC_2  ,  KC_3  , _______, _______,
